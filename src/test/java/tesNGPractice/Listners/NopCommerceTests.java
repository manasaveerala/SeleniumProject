package tesNGPractice.Listners;
...
@Listeners(tesNGPractice.Listners.ExtentReportManager.class)
...
WebDriver driver;
	...
	void testLogin()
	{
		try
		{
			...
			Thread.sleep(3000);
			driver.findElement(By.xpath("//input[@id='Email']")).sendKeys("padmanabhaa@gmail.com");
